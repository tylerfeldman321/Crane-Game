...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { game_active }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { increment_score }]; #IO_L12P_T1_MRCC_14 Sch=btnl
...
# set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { increment_score }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
...
##Pmod Header JB
# set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { increment_score }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
