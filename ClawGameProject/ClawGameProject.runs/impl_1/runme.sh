...
HD_PWD='C:/Users/tyler/Documents/Spring2022/ECE350/final-project-team-25/ClawGameProject/ClawGameProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clawgame_proc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clawgame_proc.tcl -notrace
