...
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMO S33 } [get_ports { SW[2] }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
...
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { score_increment }]; #IO_L4N_T0_D05_14 Sch=btnu
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { score_increment }]; #IO_L12P_T1_MRCC_14 Sch=btnl
...
# set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { score_increment }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { score_increment }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
